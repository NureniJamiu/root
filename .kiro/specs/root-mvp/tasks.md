...
- [ ] 2. Data Model Layer — types and schema
  - [-] 2.1 Implement Zod schemas and inferred types
  ...
  - [~] 2.2 Write unit tests for canvasSchema.superRefine
...
- [ ] 5. Data Model Layer — serialization and public surface
  - [~] 5.1 Implement serializeCanvas and parseCanvas
